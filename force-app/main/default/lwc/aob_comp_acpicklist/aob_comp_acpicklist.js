...
export default class Aob_comp_acPicklist extends LightningElement {
    ...
    businessType = [{"Name":"SOLE PROPRIETOR","AOB_Code__c":"SOLE PROPRIETOR"},{"Name":"PRIVATE COMPANY","AOB_Code__c":"PRIVATE COMPANY"},{"Name":"CLOSE CORPORATION","AOB_Code__c":"CLOSE CORPORATION"},
    ...
    fireChangeEvent(newValue) {
        console.log('check event name ',this.name);
