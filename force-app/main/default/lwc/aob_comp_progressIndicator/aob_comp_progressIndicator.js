...
export default class Aob_progressIndicator extends LightningElement {
    @api title = 'MYMOBIZ APPLICATION';
    ...
    initializeProgressRing() {
        ...
        if (this.stagenames && this.stagenames.includes(',')) {
            ...
            for (var i = 0; i < stageNamelst.length; i++) {
                this.progressIndicatorsStages.push({ progressWidth: 'width:0%', stagenumber: i + 1, stagename: stageNamelst[i], stagevaluenow: 0, statename: "active", middleStage: true, lastStage: false, firstStage: false });
        ...
        for (var i = 0; i < totalSetps; i++) {
            ...
            if (this.currentstagenumber > this.progressIndicatorsStages[i].stagenumber) {
                this.progressIndicatorsStages[i].progressWidth = 'width:100%;background: #4caf50;';
            }
        ...
        if (totalSetps == 2) {
            this.progressIndicatorsStages[0].progressWidth = 'width:100%;background: #4caf50;';
            this.progressIndicatorsStages[1].progressWidth = 'width:100%;background: #4caf50;';
        }
