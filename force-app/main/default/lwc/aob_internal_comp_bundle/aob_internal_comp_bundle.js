...
import AOB_ZA_Addtobundle from '@salesforce/label/c.AOB_ZA_Addtobundle';

export default class Aob_internal_comp_bundle extends LightningElement {
    label = {
        AOB_ZA_Addtobundle
    };
