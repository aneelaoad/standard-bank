...
import AOB_ZA_AVERAGEMonthlyAmount from '@salesforce/label/c.AOB_ZA_AVERAGEMonthlyAmount';
export default class Aob_internal_comp_multiselectfilter extends LightningElement {
  label = {
    AOB_ZA_AVERAGEMonthlyAmount
  };
  @track listOfInputs = {};
