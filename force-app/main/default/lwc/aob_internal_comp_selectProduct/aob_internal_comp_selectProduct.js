/**
 * @description       : Child Component to Search Product for selecting a product.
...
import fetchRecords from '@salesforce/apex/AOB_internal_CTRL_Onboarding.fetchRecords';

export default class aob_internal_comp_selectProduct extends LightningElement {
    ...
    getProductId(product){
        const message= new CustomEvent('buttonclick',{detail:product});
        this.dispatchEvent(message);
    }
    selectItem(event) {
        this.getProductId(event.currentTarget.dataset.key);
