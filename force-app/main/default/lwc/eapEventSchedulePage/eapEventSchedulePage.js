...
import EVENT_SCHEDULE_LABEL from '@salesforce/label/c.Eap_EventSchedule_Label';

export default class EapEventSchedulePage extends LightningElement {
    title = EVENT_SCHEDULE_LABEL;
    @track loading = true;
    @track eventId;
