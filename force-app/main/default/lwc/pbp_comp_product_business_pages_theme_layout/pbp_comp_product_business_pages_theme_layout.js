...
export default class PbpCompProductBusinessPagesThemeLayout extends  NavigationMixin(LightningElement){
    AfricaflagsFilter = [];
    EuropeflagsFilter = [];
    ...
    constructor() {
        super();
        this.screenSizeWindowDetector();
    
    }
    navigatetoouraccounts(){
    ...
    screenSizeWindowDetector(){
            ...
            else if(window.screen.width>=481 && window.screen.width<=1023){
                this.isDesktopDevice = false;
    ...
    connectedCallback() {
        ...
        window.addEventListener('resize', this.screenSizeWindowDetector.bind(this));
    }
    getAllTabs() {
