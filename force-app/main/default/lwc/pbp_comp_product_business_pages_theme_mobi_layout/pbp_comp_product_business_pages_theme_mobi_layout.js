...
export default class Pbp_comp_product_business_pages_theme_mobi_layout extends LightningElement {
    AfricaflagsFilter = [];
    EuropeflagsFilter = [];
    ...
    //retailonlineurl='https://ucount.standardbank.co.za/personal/redeem-points/where-to-redeem-points/rewards-retailers/';
    ucountrewardurl='https://ucount.standardbank.co.za/personal/';
    learnurl=standardbankurl +'/southafrica/personal/learn';
    bankwithusurl=PBP_ZA_siteUrl +'/southafrica/business/products-and-services/bank-with-us/business-bank-accounts/our-accounts';
    ...
    //creditcardurls=standardbankurl +'/southafrica/business/products-and-services/bank-with-us/company-cards/our-cards';
